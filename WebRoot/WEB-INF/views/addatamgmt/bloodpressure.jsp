...
<html>
  ...
  <body class="no-skin">
					...
					<div class="box-inner">
						...
						<div class="widget-body">
							...
							<div class="input-append center">
						        ...
						        <button style="height:32px" class="btn btn-primary btn-xs"  type="button" onclick="getbpList()">
    ...
    <script type="text/javascript">
		...
		function getbpList() {
			var url= "<%=basePath%>/addatamgmt/getbpdata";
		...
		function deleteSubmit() {
			...
			$.ajax({
				url: "<%=basePath%>/addatamgmt/deletebpdata",
				type: "POST",
				datatype: "json",
				traditional: true,
				data: {ids: ids},
