...
<html>
  ...
  <body class="no-skin">
					...
					<div class="box-inner">
						...
						<div class="widget-body">
							...
							<div class="input-append center">
						        ...
						        <button style="height:32px" class="btn btn-primary btn-xs"  type="button" onclick="getecgList()">
    ...
    <script type="text/javascript">
		...
		function getecgList() {
			var url= "<%=basePath%>/addatamgmt/getecgdata";
		...
		function deleteSubmit() {
			...
			$.ajax({
				url: "<%=basePath%>/addatamgmt/deleteecgdata",
				type: "POST",
				datatype: "json",
				traditional: true,
				data: {ids: ids},
