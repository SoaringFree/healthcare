...
<html>
  ...
  <body class="no-skin">
					...
					<div class="box-inner">
						...
						<div class="widget-body">
							...
							<div class="input-append center">
						        ...
						        <button style="height:32px" class="btn btn-primary btn-xs"  type="button" onclick="getMyBpList()">
    ...
    <script type="text/javascript">
		...
		function getMyBpList() {
			var url= "<%=basePath%>/ptdatamgmt/getmybpdata";
		...
		function initBpList(bpList, page) {
			...
			if (null != bpList) {
				$.each(bpList, function(index, item) {
					...
					tr.append(td1).append(td2).append(td5).append(td6).append(td7).append(td8).append(td9).append(td10);
