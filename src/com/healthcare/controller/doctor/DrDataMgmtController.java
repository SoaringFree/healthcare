 ...
 */
@Controller
@RequestMapping("/drdatamgmt")
@SessionAttributes("UserSession")
public class DrDataMgmtController {
...
protected final Log logger = LogFactory.getLog(getClass()); 
	...
	**************************************************************************/
	...
	{
		return new ModelAndView("/drdatamgmt/electrocardiogram");
	}
	...
	public Object getEcgData(int page, int rows, 
		...
		if(null!=(body = spSrv.executeSP("getdoctorpatientecg", new Object[]{page, rows, doctorId, patientId, startTime, endTime})))
			map.put("result", body);
		total = ecgSrv.countDoctorPatientEcg(doctorId, patientId, startTime, endTime);
	...
	**************************************************************************/
	...
	{
		return new ModelAndView("/drdatamgmt/bloodoxygen");
	}
	...
	public Object getSpo2Data(int page, int rows,
		...
		if(null!=(body = spSrv.executeSP("getdoctorpatientspo2", new Object[]{page, rows, doctorId, patientId, startTime, endTime})))
			map.put("result", body);
		total = spo2Srv.countDoctorPatientSpo2(doctorId, patientId, startTime, endTime);
	...
	**************************************************************************/
	...
	{
		return new ModelAndView("/drdatamgmt/bloodpressure");
	}
	...
	public Object getBpData(int page, int rows,
		...
		if(null!=(body = spSrv.executeSP("getdoctorpatientbp", new Object[]{page, rows, doctorId, patientId, startTime, endTime})))
			map.put("result", body);
		total = bpSrv.countDoctorPatientBp(doctorId, patientId, startTime, endTime);
	...
	**************************************************************************/
	...
	{
		return new ModelAndView("/drdatamgmt/bloodglucose");
	}
	...
	public Object getGluData(int page, int rows,
		...
		if(null!=(body = spSrv.executeSP("getdoctorpatientglu", new Object[]{page, rows, doctorId, patientId, startTime, endTime})))
			map.put("result", body);
		total = gluSrv.countDoctorPatientGlu(doctorId, patientId, startTime, endTime);
