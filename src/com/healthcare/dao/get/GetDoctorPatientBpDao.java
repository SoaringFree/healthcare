 ...
 */
@Repository
public class GetDoctorPatientBpDao extends BaseStoredProcedureDao<BloodPressure> {
	...
	protected StoredProcedure buildStoredProcedure() {
		return new DoctorPatientBpSP();
	}
	
	public class DoctorPatientBpSP extends StoredProcedure {
		DoctorPatientBpSP() {
			super();
			//定义参数
